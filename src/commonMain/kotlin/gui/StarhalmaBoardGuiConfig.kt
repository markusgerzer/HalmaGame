...
object StarhalmaBoardGuiConfig {
    const val STAR_HALMA_BOARD_GUI_WIDTH = 1024.0
    const val STAR_HALMA_BOARD_GUI_HEIGHT = 1024.0
    const val SCALE_Y = 0.82
    const val FIELD_RADIUS = 14.0
    const val MARK_RADIUS = 24.0
    const val LINE_THICKNESS = 1.25
    const val MARK_LINE_THICKNESS = 7.0 * LINE_THICKNESS
    const val BUTTON_SIZE = 92.0
    const val BUTTON_IMAGE_SIZE = .9 * BUTTON_SIZE
    const val ROUND_TEXT_SIZE = 32.0
    const val MSG_TEXT_SIZE = 40.0
    const val MSG_BOX_STROKE_THICKNESS = 12.0 * LINE_THICKNESS
    const val BUTTON_PADDING = 34.0
    const val MSG_TEXT_PADDING = 30.0
    const val MSG_BOX_WIDTH = 360
    const val MSG_BOX_HEIGHT = 175
    const val MSG_BOX_RX = 8
    const val GO_BUTTON_X_PADDING = 100
    const val GO_BUTTON_Y_PADDING = 60
    const val xFactor = 39.5
